...
//		boardPanel.setBackground(Color.white);
		...
		comboBox = new JComboBox<String>(new String[] { "Easy", "Medium", "Hard" });
...
//					handleExceptionInput(board[i][j]);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == jbSolved) {
			if (!isEmtry()) {
				...
				JOptionPane.showMessageDialog(this, "You have to create again");
    ...
    // New method to play background music
